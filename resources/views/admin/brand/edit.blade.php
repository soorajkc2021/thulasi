            ...
            <div class="card">
              ...
              <div class="card-body">
                  ...
                  <div class="" id="settings">
                    <form class="form-horizontal" id="form_create" method="PUT" data-url="/admin/brands/{{ $brand->id }}" >
                      @csrf
                      <div class="form-group row">
                        <label for="inputName" class="col-sm-3 col-form-label required-field">Name</label>
                        <div class="col-sm-9">
                          <input type="text" id="name" class="form-control" required="required" value="{{$brand->name }}" name="name"  id="inputName" placeholder="Name">
            ...
            $("#editSubmit").click(function(){
              ...
              $.ajax({
                    ...
                    success: function(data){
                      toastr.success('Brand Updated Successfully',"Sucesss");
