        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Brand User</li>
            </ol>
          </div>
        </div>
     @stop
            ...
            <div class="card">
              ...
              <div class="card-body">
                  <div class="" id="settings">
                    <form class="form-horizontal" id="form_create" method="POST" data-url="/admin/brands" >
                      @csrf
              ...
              $.ajax({
                    ...
                    success: function(data){
                      if(data.message == 'success'){
                          toastr.success('Brand Created Successfully',"Sucesss");
