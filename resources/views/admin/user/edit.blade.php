                  ...
                  <div class="" id="settings">
                    <form class="form-horizontal" id="form_create" method="POST" data-url="/admin/user/edit/{{ $user->id }}" >
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <input type="text" id="name" class="form-control" required="required" value="{{$user->name }}" name="name"  id="inputName" placeholder="Name">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <input type="email"  id="email" class="form-control" required="required" value="{{$user->email }}" name="email" id="inputEmail" placeholder="Email">
