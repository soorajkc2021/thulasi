            ...
            <div class="card">
              ...
              <div class="card-body">
                  <div class="" id="settings">
                    <form class="form-horizontal" id="form_create" method="POST" data-url="/admin/products" >
                      @csrf
                          ...
                          <div class="col-md-6">
                            <div class="form-group row">
                              ...
                              <div class="col-sm-8">
                                ...
                                <span id="error_brand" class="error-text text-danger pull-right" style=""></span>
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                              ...
                              <span id="error_subcategory" class="error-text text-danger pull-right" style=""></span>
              ...
              $.ajax({
                    ...
                    success: function(data){
                      if(data.message == 'success'){
                          toastr.success('Product Created successfully',"Sucesss");
